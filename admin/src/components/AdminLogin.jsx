...
const AdminLogin = () => {
  ...
  return (
    <div className='relative min-h-screen flex items-center justify-center bg-linear-to-r from-indigo-900 via-purple-900 to-pink-900 overflow-hidden'>
      ...
      <form onSubmit={handleSubmit} className='relative z-10 w-96 bg-white/10 shadow-2xl border border-white/20 backdrop-blur-xl p-8 rounded-2xl flex flex-col items-center transition-all duration-300 hover:scale-[1.02]'>
        ...
        <button type='submit' className='w-full bg-linear-to-r from-indigo-600 via-purple-600 to-pink-500 p-3 rounded-lg text-white font-semibold hover:shadow-pink-500/30 hover:scale-[1.03] shadow-lg transition-all duration-300'>Login</button>
      </form>
    </div>
  )
}
